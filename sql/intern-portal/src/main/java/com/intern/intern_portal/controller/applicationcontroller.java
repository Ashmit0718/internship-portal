...
import org.springframework.beans.factory.annotation.Autowired; // madat karto spring framework la object create karnyasathi
import org.springframework.web.bind.annotation.*; //import all
//import java.util.List;

// Cross origin resource sharing
@CrossOrigin(origins = "http://localhost:5500") //5500 frontend 8080 backend
@RestController     
